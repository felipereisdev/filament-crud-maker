...
After publishing, the config file is located at `config/filament-crud-generator.php`:
...
```bash
git clone https://github.com/felipereisdev/filament-crud-generator.git
cd filament-crud-generator
composer install
```
